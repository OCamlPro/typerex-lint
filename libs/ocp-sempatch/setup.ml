...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0c09477c3f0a386ddf7aa2d82c74e360) *)
(*
...
let setup_t =
  {
     ...
     build = OCamlbuildPlugin.build ["-tag"; "safe_string"];
     test =
       [
          ("test",
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ppx_patch"; "Ast_filter"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "+G\221\004O\021s\2478\180\195\255Z<\156\193";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
