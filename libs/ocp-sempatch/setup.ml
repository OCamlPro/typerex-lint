...
(* OASIS_START *)
(* DO NOT EDIT (digest: e09111f1930d0c04d98e48b3236a5382) *)
(*
...
let setup_t =
  {
     ...
     build = OCamlbuildPlugin.build ["-tag"; "safe_string"; "-use-menhir"];
     test =
       [
          ("test",
     ...
     package =
       {
          ...
          alpha_features = ["stdfiles_markdown"; "ocamlbuild_more_args"];
          beta_features = [];
          name = "foo";
          version = "0.1";
          license =
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "patch_engine.ml"});
               Executable
                 ({
                     cs_name = "test_patch";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_path = "patch";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "ppx_patch"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "test_patch.ml"});
               Executable
                 ({
                     cs_name = "parser_test";
                     cs_data = PropList.Data.create ();
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "sh"]
                   })
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\018\156\233\236jwh|\022\015\222\177\234\023)\146";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
