...
(* OASIS_START *)
(* DO NOT EDIT (digest: ae188ab9a3ae4d3cfefcd0664ac5219d) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_patch.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\239\011ED\137;\228\214\187\251I\161vNj\017";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
