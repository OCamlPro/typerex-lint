...
(* OASIS_START *)
(* DO NOT EDIT (digest: 331ea0f705f6c226782851fdd823d479) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ppx_patch"; "Patch_engine"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ppx_patch"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\166\251\165\024\015\206&H!*\237g\150A\028\163";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
